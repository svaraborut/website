...
import { GitHubBadge, GitHubCopilot, NpmBadge } from '~/assets/stackicons'
    ...
    return (
        <Container className="grid grid-cols-1 gap-24 py-32 text-white sm:grid-cols-2 lg:grid-cols-3">
            <div className="sm:col-span-2 lg:col-span-1 lg:row-span-2">
                <p className="mb-16 max-w-3xl text-5xl font-bold md:text-6xl">Packages</p>
                ...
                <a key={ix} className="group flex gap-6" href={ex.url} target="_blank">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex gap-2">
                            ...
                            <p className="font-mono text-2xl font-bold leading-none transition duration-500 group-hover:text-pink-600">
                                {ex.title}
                            </p>
                        </div>
